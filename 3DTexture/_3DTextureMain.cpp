...
_3DTextureMain::_3DTextureMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void _3DTextureMain::CreateWindowSizeDependentResources() 
{
...
void _3DTextureMain::OnDeviceLost()
{
...
void _3DTextureMain::OnDeviceRestored()
{
