...
{
	std::string path = "Assets\\Textures\\LeeJY_TIF";
	CreateWICTextureFromFile(m_deviceResources->GetD3DDevice(), path + "LeeJY_CT_2008_010000",)
}
...
void Sample3DSceneRenderer::CreateDeviceDependentResources()
{
	...
	CreateWICTextureFromFile(m_device, L"sunset.jpg", texture.GetAddressOf(), m_MRI_texture_vector[0].GetAddressOf());
}
